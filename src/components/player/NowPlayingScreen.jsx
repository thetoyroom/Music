    ...
    <div className={styles.screen}>
      ...
      <header className={styles.header}>
        ...
        <div className={styles.headerActions}>
          <button 
            className={`${styles.lyricsToggle} ${(isDesktop ? showLyricsDesktop : showLyricsMobile) ? styles.lyricsToggleActive : ''}`}
            onClick={() => isDesktop ? setShowLyricsDesktop(!showLyricsDesktop) : setShowLyricsMobile(!showLyricsMobile)}
            title="Toggle Lyrics"
          >
            <LyricsIcon size={20} />
          </button>
      ...
      <main className={`${styles.main} ${isDesktop ? styles.desktopMain : ''}`}>
            ...
            <div className={styles.metaRow}>
              <div className={styles.titles}>
                ...
                <div className={styles.artistRow}>
                  ...
                  <button 
                    className={`${styles.viewToggle} ${viewMode === 'queue' ? styles.viewToggleActive : ''}`}
        ...
        {(isDesktop ? showLyricsDesktop : showLyricsMobile) && (
